...
var platform = {
   ...
   displayMessages: function(taskMode) {
      ...
      switch (taskMode) {
         ...
         case "unsaved_changed":
            messages["validate"] = "<input type='button' value='Enregistrer votre réponse' onclick='platform.validate(\"done\")'></input>";
            break;
         case "saved_unchanged":
            messages["saved"] = "Votre réponse a été enregistrée, vous pouvez <a href='#' onclick='platform.validate(\"cancel\");return false'>l'annuler</a> et recommencer." +
               "<br/><input type='button' value='Voir son score et la solution' onclick='platform.showSolution();return false;'></input>";
            break;
         case "saved_changed":
            messages["saved"] = "<b style='color:red'>Attention: une réponse différente est enregistrée</b>, vous pouvez <a href='#' onclick='platform.retreiveAnswer();return false'>la recharger</a>.";
            messages["validate"] = "<input type='button' value='Enregistrer cette nouvelle réponse' onclick='platform.validate(\"done\")'></input><br/>";
            break;
      }
   ...
   validate: function(validationMode) {
      if (this.taskMode == "#task-solution") {
         alert("Vous ne pouvez plus modifier votre réponse une fois la solution affichée.");
         return;
      }
